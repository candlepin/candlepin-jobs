...
job("$baseFolder/CandlepinPerformance") {
    ...
    steps {
        ansiblePlaybook('ansible/candlepin.yml') {
            ...
            additionalParameters('--extra-vars=\"candlepin_branch=${ghprbActualCommit} caracalla_branch=${caracalla_branch} candlepin_throughput_properties=${candlepin_throughput_properties} jmeter_tests=${jmeter_tests} target_branch=${target_branch} keep_logs=${keep_logs}\"')
